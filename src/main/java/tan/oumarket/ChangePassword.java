            ...
            if(password1.getText().equals(password2.getText()) )
            {
               ...
               // prepare.setInt(2, data.id_user);
                ...
                SwitchPage sw = new SwitchPage(root);
                    ...
                    in.infoBox("password does not match", "Error Message", "2");                     in.infoBox("password does not match", "Error Message", "2");                    in.infoBox("password does not match", "Error Message", "2");
